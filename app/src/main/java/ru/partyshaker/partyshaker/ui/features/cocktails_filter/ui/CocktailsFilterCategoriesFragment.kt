...
import ru.partyshaker.partyshaker.databinding.CocktailsFilterCategoriesBinding
...
class CocktailsFilterCategoriesFragment : Fragment(), View.OnClickListener {
    ...
    private lateinit var binding: CocktailsFilterCategoriesBinding
    ...
    override fun onCreateView(
        ...
        binding = CocktailsFilterCategoriesBinding.inflate(inflater, container, false)
