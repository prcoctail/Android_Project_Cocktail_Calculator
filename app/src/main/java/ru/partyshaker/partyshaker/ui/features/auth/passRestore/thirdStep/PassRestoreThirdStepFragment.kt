package ru.partyshaker.partyshaker.ui.features.auth.passRestore.thirdStep
...
class PassRestoreThirdStepFragment : Fragment(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            applyButton.id -> {
                findNavController().navigate(R.id.action_passRecoveryThirdStepFragment_to_authorizationFragment)
            }
        }
    }
}
