...
import ru.partyshaker.partyshaker.databinding.CocktailsFilterIngredientsBinding
...
class CocktailsFilterIngredientsFragment : Fragment(), View.OnClickListener {
    ...
    private lateinit var binding: CocktailsFilterIngredientsBinding
    ...
    override fun onCreateView(
        ...
        binding = CocktailsFilterIngredientsBinding.inflate(inflater, container, false)
    ...
    private fun createChip(
        ...
        val chip =
            this.layoutInflater.inflate(
                R.layout.cocktails_filter_list_item,
                chipGroupContainer,
                false
            ) as Chip
